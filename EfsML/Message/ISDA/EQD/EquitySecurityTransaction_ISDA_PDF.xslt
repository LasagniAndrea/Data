...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dt="http://xsltsl.org/date-time" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
	...
	<!--
	==============================================================
	Summary : Equity Security Transaction ISDA PDF
	==============================================================
	==============================================================
	File    : EquitySecurityTransaction_ISDA_PDF.xslt
	Date    : 20.03.2015
	Author  : Pony LA
	Version : 4.6.0.0
	Description: Add Equity Statement 
	==============================================================
	-->	
	...
	<xsl:import href="EquityOption_ISDA_Business.xslt"/>
		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:page-sequence master-reference="A4" initial-page-number="1" font-family="{$varFontFamily}">
				...
				<fo:flow flow-name="A4-body">
					...
					<xsl:call-template name="displayConfirmationStatementTitle"/>
          ...
          <xsl:call-template name="displayEqdStatementText"></xsl:call-template>
          <xsl:call-template name="displayBlockBreakline"/>

          <!-- Call template to Display Statement General Terms (Transaction type, Transaction reference, etc.) -->
          <xsl:call-template name="displayEqdStatementGeneralTerms">
            <xsl:with-param name="pEquityOption" select="//dataDocument/trade/equityOption" />
          </xsl:call-template>
          <xsl:call-template name="displayBlockBreakline"/>

          <!-- Call template Display Statement Settlement Terms (Transaction gross amount, Commissions, etc.) -->
          <xsl:call-template name="displayEqdStatementSettlementTerms">
            <xsl:with-param name="pEquityOption" select="//dataDocument/trade/equityOption" />
          </xsl:call-template>
          <xsl:call-template name="displayBlockBreakline"/>
