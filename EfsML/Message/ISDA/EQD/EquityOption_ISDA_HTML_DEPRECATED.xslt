...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"  version="1.0">
	...
	<!--
	==============================================================
	Summary : EquityOption ISDA HTML
	==============================================================
	File    : EquityOption_ISDA_HTML.xslt
	Date    : 20.05.2009
  ...
  <xsl:include href="..\..\..\Library\xsltsl\date-time.xsl"/>
	...
	<xsl:template name="displayConfirmationBody">
		...
		<xsl:call-template name="BreakLine"/>
		<xsl:call-template name="displayEqdConfirmationText">
			<xsl:with-param name="pTDCSS" select="$pTDCSS"/>
		</xsl:call-template>
		<xsl:call-template name="BreakLine"/>
		<!-- Swaption Terms (notional amount, trade date, etc.) -->
