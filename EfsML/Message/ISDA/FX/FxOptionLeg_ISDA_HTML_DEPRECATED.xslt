...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"  version="1.0">
  ...
  <!--
	==============================================================
	Summary : FxOptionLeg ISDA HTML
	==============================================================
	File    : FxOptionLeg_ISDA_HTML.xslt
	Date    : 20.05.2009
  ...
  <xsl:import href="FxOptionLeg_ISDA_Business.xslt"/>
  ...
  <xsl:template name="displayConfirmationBody">
    ...
    <xsl:call-template name="BreakLine"/>
    <xsl:call-template name="displayFxOptionLegTerms">
      <xsl:with-param name="pFxOption" select="//dataDocument/trade/fxSimpleOption" />
