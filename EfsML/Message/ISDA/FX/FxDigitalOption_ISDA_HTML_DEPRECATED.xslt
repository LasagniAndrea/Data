...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <!--
	==============================================================
	Summary : FxDigitalOption ISDA HTML
	==============================================================
	File    : FxDigitalOption_ISDA_HTML.xslt
	Date    : 20.05.2009
  ...
  <xsl:import href="FxDigitalOption_ISDA_Business.xslt"/>
  ...
  <xsl:template name="displayConfirmationBody">
    ...
    <xsl:call-template name="displayFxDigitalTerms">
      <xsl:with-param name="pFxOption" select="//dataDocument/trade/fxDigitalOption" />
      <xsl:with-param name="pIsNonDeliverable" select="false" />
      <xsl:with-param name="pTDCSS" select="$pTDCSS"/>
    </xsl:call-template>
    <xsl:call-template name="BreakLine"/>

    <!-- Display addition definitions (ex. Event Period..) -->
    <!--
		<xsl:call-template name="displayAdditionalDefinitions"/>
		<xsl:call-template name="BreakLine"/>
		-->
