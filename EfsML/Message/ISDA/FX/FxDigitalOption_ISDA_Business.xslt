...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <!--
	==============================================================
	Summary : FxDigitalOption ISDA Business
	==============================================================
	File    : FxDigitalOption_ISDA_Business.xslt
	Date    : 20.05.2009
  ...
  <!-- variables -->
  <xsl:variable name="partyID_1" select="//dataDocument/trade/fxDigitalOption/buyerPartyReference/@href"/>
  <xsl:variable name="partyID_2" select="//dataDocument/trade/fxDigitalOption/sellerPartyReference/@href"/>
  <!-- variable in false -->
