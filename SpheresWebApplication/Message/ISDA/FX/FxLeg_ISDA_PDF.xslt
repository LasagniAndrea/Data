      ...
      <fo:page-sequence master-reference="A4" initial-page-number="1" font-family="{$varFontFamily}">
        ...
        <fo:flow flow-name="A4-body">
          ...
          <xsl:call-template name="displayFxConfirmationText">
            <!--<xsl:with-param name="pIsBullion" select="substring(//dataDocument/trade/fxSingleLeg/exchangedCurrency1/paymentAmount/currency,1,1)='X'" />-->
            <xsl:with-param name="pIsBullion" select="$varCU1='XAU' or $varCU1='XAG' or $varCU1='XPT' or $varCU1='XPD'" />
          </xsl:call-template>
          ...
          <!--<xsl:call-template name="displayBlockBreakline"/> PL 20150324-->
