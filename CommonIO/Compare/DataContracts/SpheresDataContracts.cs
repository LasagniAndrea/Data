...
namespace IOCompareCommon.DataContracts
{
    ...
    public sealed class CashFlowsCompareData : ISpheresComparer, IIoTrackElements, ISupportKey
    {
        ...
        public void Initialise()
        {
            m_QuantityByKeyName = new Dictionary<string, ValueErrorStatus>
            {
                {"TAXCOMAMT",new ValueErrorStatus(TaxComAmt, MatchStatus.UNMATCH_TAXCOMAMT, TaxComAct > 0, TaxComEpsilon)},
                {"COLLAMT",new ValueErrorStatus(CollAmt, MatchStatus.UNMATCH_COLLAMT, CollAct > 0, CollEpsilon)},
                {"PMTAMT",new ValueErrorStatus(PmtAmt, MatchStatus.UNMATCH_PMTAMT, PmtAct > 0, PmtEpsilon)},
                {"PRMAMT",new ValueErrorStatus(PrmAmt, MatchStatus.UNMATCH_PRMAMT, PrmAct > 0, PrmEpsilon)},
                {"VRMRGNAMT",new ValueErrorStatus(VrMrgnAmt, MatchStatus.UNMATCH_VRMRGNAMT, VrMrgnAct > 0, this.VrMrgEpsilon)},
                {"TAXCOMBRKAMT",new ValueErrorStatus(TaxComBrkAmt, MatchStatus.UNMATCH_TAXCOMBRKAMT, TaxComBrkAct > 0, this.TaxComBrkEpsilon)},
                {"CALLAMT",new ValueErrorStatus(CallAmt, MatchStatus.UNMATCH_CALLAMT, CallAct > 0, this.CallEpsilon)},
                {"RPTAMT",new ValueErrorStatus(RptAmt, MatchStatus.UNMATCH_RPTAMT, RptAct > 0, this.RptEpsilon)},
                {"CSBAMT",new ValueErrorStatus(CSBAmt, MatchStatus.UNMATCH_RPTAMT, CSBAct > 0, this.RptEpsilon)}
            };
        }
    ...
    public sealed class CashFlowsInstrCompareData : ISpheresComparer, IIoTrackElements, ISupportKey
    {
        ...
        public void Initialise()
        {
            m_QuantityByKeyName = new Dictionary<string, ValueErrorStatus>
            {
                {"UMGAMT",new ValueErrorStatus(UMgAmt, MatchStatus.UNMATCH_UMGAMT, UMgAct > 0, this.UMgEpsilon)},
                {"PRMAMT",new ValueErrorStatus(PrmAmt, MatchStatus.UNMATCH_PRMAMT, PrmAct > 0, this.PrmEpsilon)},
                {"VRMRGNAMT",new ValueErrorStatus(VrMrgnAmt, MatchStatus.UNMATCH_VRMRGNAMT, VrMrgnAct > 0, this.VrMrgEpsilon)},
                {"LOVAMT",new ValueErrorStatus(LovAmt, MatchStatus.UNMATCH_LOVAMT, LovAct > 0, this.LovEpsilon)},
                {"RMGAMT",new ValueErrorStatus(RMgAmt, MatchStatus.UNMATCH_RMGAMT, RMgAct > 0, this.RMgEpsilon)},
                {"TAXCOMBRKAMT",new ValueErrorStatus(TaxComBrkAmt, MatchStatus.UNMATCH_TAXCOMBRKAMT, TaxComBrkAct > 0, this.TaxComBrkEpsilon)}
            };
        }
