...
{
    /// <summary>
    /// Class pour importation des Trades Risk (Cash Payment, ....)
    /// </summary>
    internal class ProcessTradeRiskImport : ProcessTradeImportBase
    {
        #region Members
        ...
        /// 
        /// </summary>
        public TradeRiskCaptureGen TradeRiskCaptureGen
        {
            get { return (TradeRiskCaptureGen)_captureGen; }
        }
        ...
        #region Constructor
        public ProcessTradeRiskImport(TradeImport pTradeImport, IDbTransaction pDbTransaction, Task pTask)
        ...
        /// FI 20131213 [19319] add LogHeader
        ...
        {
            CheckTradeRiskValidationRule check = new CheckTradeRiskValidationRule(this.TradeRiskCaptureGen.Input, pCaptureMode, pUser);
