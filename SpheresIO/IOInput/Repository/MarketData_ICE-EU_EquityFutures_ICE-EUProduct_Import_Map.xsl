...
<!-- 
=============================================================================================
 Summary  : Import de la feuille "Individual Equity Futures" du fichier Excel bclear.       
 File     : MarketData_ICE-EUEquityFutures_ICE-EUProduct_Import_Map.xsl
=============================================================================================
 Version  : v3.2.0.0                                              
 Date     : 20130314                                          
 File     : BD & FL                                                 
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="row">
    ...
    <!-- On génére le <row> uniquement si AssetName ne débute pas par :
         ...
         Il s'agit de la dernière ligne de la feuille "Individual Equity Futures" :
          "*The Exchange Delivery Settlement Price (“EDSP”)/Option Reference Price for Individual Equity Options based on NYSE or NASDAQ underlyings is based upon" -->
    <xsl:if test="starts-with(data[@name='AssetName'],'*The Exchange Delivery Settlement Price')=false()">
      ...
      <row>
        ...
        <xsl:call-template name="rowStreamCommon_ICE-EU">
          <xsl:with-param name="pSheetName" select="'IndividualEquityFutures'"/>
        </xsl:call-template>
