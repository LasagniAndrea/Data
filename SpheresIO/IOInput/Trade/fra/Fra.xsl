      ...
      <tradeImport xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
        ...
        <tradeInput>
          <customCaptureInfos>
            ...
            <customCaptureInfo clientId="fra_buyer" dataType="string">
              <value>
                <xsl:value-of select="data[@name='ACTOR1']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="fra_seller" dataType="string">
              <value>
                <xsl:value-of select="data[@name='ACTOR2']"/>
              </value >
            </customCaptureInfo>
            <customCaptureInfo clientId="fra_adjustedEffectiveDate" dataType="date">
              <value>
                <xsl:value-of select="data[@name='FRA_EFFECTIVE_DATE']"/>
              </value >
            </customCaptureInfo>
            <customCaptureInfo clientId="fra_adjustedTerminationDate" dataType="date">
              <value>
                <xsl:value-of select="data[@name='FRA_TERMINATION_DATE']"/>
              </value >
            </customCaptureInfo>
            <customCaptureInfo clientId="fra_paymentDate_dateAdjustments_bDC" dataType="string">
              <value>
                <xsl:value-of select="data[@name='FRA_PAYMENTDATE_ADJUSTMENT']"/>
              </value >
            </customCaptureInfo>
            <customCaptureInfo clientId="fra_notional_amount" dataType="decimal" >
              <value>
                <xsl:value-of select="data[@name='FRA_NOTIONAL_AMOUNT']"/>
              </value >
            </customCaptureInfo>
            <customCaptureInfo clientId="fra_notional_currency" dataType="string">
              <value>
                <xsl:value-of select="data[@name='FRA_NOTIONAL_CURRENCY']"/>
              </value >
            </customCaptureInfo>
            <customCaptureInfo clientId="fra_floatingRateIndex" dataType="string">
              <value>
                <xsl:value-of select="data[@name='FRA_FLOATINRATEINDEX']"/>
              </value >
            </customCaptureInfo>
            <customCaptureInfo clientId="fra_fixedRate" dataType="decimal" >
              <value>
                <xsl:value-of select="data[@name='FRA_FIXEDRATE']"/>
              </value >
            </customCaptureInfo>
            <customCaptureInfo clientId="fra_dayCountFraction" dataType="string">
              <value>
                <xsl:value-of select="data[@name='FRA_DCF']"/>
              </value >
            </customCaptureInfo>
