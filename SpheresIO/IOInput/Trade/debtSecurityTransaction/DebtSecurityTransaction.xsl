		...
		<row>
			...
			<tradeImport>
				<settings>
					...
					<parameters>
						<parameter name="http://www.efs.org/otcml/tradeImport/instrumentIdentifier" datatype="string">debtSecurityTransaction</parameter>
						<parameter name="http://www.efs.org/otcml/tradeImport/templateIdentifier" datatype="string">debtSecurityTransaction</parameter>
						<!-- screen from instrument default -->
						<parameter name="http://www.efs.org/otcml/tradeImport/screen" datatype="string">DebtSecurityTransaction</parameter>
						<!--/////-->
						<parameter name="http://www.efs.org/otcml/tradeImport/displayname" datatype="string">debtSecurityTransaction Import Sample</parameter>
						<parameter name="http://www.efs.org/otcml/tradeImport/description" datatype="string">debtSecurityTransaction Import Sample</parameter>
				...
				<tradeInput>
					<customCaptureInfos>
						...
						<!-- securityAsset -->
						<!-- ************* -->
						<customCaptureInfo clientId="debtSecurityTransaction_securityAsset_securityId" dataType="string">
							<value>
						...
						<!-- orderQuantity -->
						<!-- ************* -->
						<customCaptureInfo clientId="debtSecurityTransaction_orderQuantity_quantityType" dataType="string">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='orderQuantity_quantityType']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="debtSecurityTransaction_orderQuantity_quantityAmount" dataType="decimal">
							<xsl:element name ="value">
						...
						<!-- orderPrice -->
						<!-- ********** -->
						<customCaptureInfo clientId="debtSecurityTransaction_orderPrice_assetMesure" dataType="string">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='orderPrice_assetMesure']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="debtSecurityTransaction_orderPrice_priceUnits" dataType="string">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='orderPrice_priceUnits']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="debtSecurityTransaction_orderPrice_price" dataType="decimal">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='orderPrice_price']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="debtSecurityTransaction_orderPrice_accruedInterestRate" dataType="decimal">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='orderPrice_accruedInterestRate']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="debtSecurityTransaction_orderPrice_accruedInterestAmount_amount" dataType="decimal">
							<xsl:element name ="value">
						...
						<!-- grossAmount -->
						<!-- *********** -->
						<customCaptureInfo clientId="debtSecurityTransaction_grossAmount_payer" dataType="string">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='grossAmount_payer']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="debtSecurityTransaction_grossAmount_paymentDate_unadjustedDate" dataType="date">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='grossAmount_paymentDate_unadjustedDate']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="debtSecurityTransaction_grossAmount_paymentAmount_amount" dataType="decimal">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='grossAmount_paymentAmount_amount']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="debtSecurityTransaction_grossAmount_paymentAmount_currency" dataType="string">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='grossAmount_paymentAmount_currency']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="debtSecurityTransaction_grossAmount_settlementInformation" dataType="string">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='grossAmount_settlementInformation']"/>
							</xsl:element>
						</customCaptureInfo>		
					</customCaptureInfos>
				</tradeInput>
