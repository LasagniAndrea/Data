    ...
    <row>
      ...
      <tradeImport xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
        <settings>
          ...
          <user>SYSADM</user>
          <parameters>
              <parameter name="http://www.efs.org/otcml/tradeImport/instrumentIdentifier" datatype="string">Collar</parameter>
              <parameter name="http://www.efs.org/otcml/tradeImport/templateIdentifier" datatype="string">Collar</parameter>
              <parameter name="http://www.efs.org/otcml/tradeImport/screen" datatype="string">Collar-Broker</parameter>
              <!--/////-->
        ...
        <tradeInput>
          <customCaptureInfos>
            ...
            <customCaptureInfo clientId="capFloorStream_payer" dataType="string">
              <value>
                <xsl:value-of select="data[@name='STREAM_PAYER']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="capFloorStream_calculationPeriodDates_effectiveDate" dataType="date">
              <value>
                <xsl:value-of select="data[@name='STREAM_EFFECTIVE_DATE']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="capFloorStream_calculationPeriodDates_terminationDate" dataType="date">
              <value>
                <xsl:value-of select="data[@name='STREAM_TERMINATION_DATE']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="capFloorStream_calculationPeriodDates_calculationPeriodFrequency_periodMultiplier" dataType="integer" regex="RegexInteger">
              <value>
                <xsl:value-of select="data[@name='STREAM_PERIODMULTIPLIER']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="capFloorStream_calculationPeriodDates_calculationPeriodFrequency_period" dataType="string">
              <value>
                <xsl:value-of select="data[@name='STREAM_PERIOD']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="capFloorStream_calculationPeriodDates_calculationPeriodFrequency_rollConvention" dataType="string">
              <value>
                <xsl:value-of select="data[@name='STREAM_ROLLCONV']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="capFloorStream_calculationPeriodDates_calculationPeriodDatesAdjustments_bDC" dataType="string">
              <value>
                <xsl:value-of select="data[@name='STREAM_BDC']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="capFloorStream_paymentDates_paymentDatesAdjustments_bDC" dataType="string">
              <value>
                <xsl:value-of select="data[@name='STREAM_BDC']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="capFloorStream_calculationPeriodAmount_calculation_notionalSchedule_notionalStepSchedule_initialValue" dataType="decimal" >
              <value>
                <xsl:value-of select="data[@name='STREAM_INITIALVALUE']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="capFloorStream_calculationPeriodAmount_calculation_notionalSchedule_notionalStepSchedule_currency" dataType="string">
              <value>
                <xsl:value-of select="data[@name='STREAM_CURRENCY']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="capFloorStream_calculationPeriodAmount_calculation_dayCountFraction" dataType="string">
              <value>
                <xsl:value-of select="data[@name='STREAM_DCF']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="capFloorStream_calculationPeriodAmount_calculation_rate" dataType="string">
              <value>
                <xsl:value-of select="data[@name='STREAM_RATE']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="capFloorStream_calculationPeriodAmount_calculation_floatingRateCalculation_floatingRateMultiplierSchedule_initialValue" dataType="decimal" >
              <value />
            </customCaptureInfo>
            <customCaptureInfo clientId="capFloorStream_calculationPeriodAmount_calculation_floatingRateCalculation_spreadSchedule_initialValue" dataType="decimal" >
              <value />
            </customCaptureInfo>
            <customCaptureInfo clientId="capFloorStream_resetDates_resetRelativeTo" dataType="string">
              <value>CalculationPeriodStartDate</value>
            </customCaptureInfo>
            <customCaptureInfo clientId="capFloorStream_calculationPeriodAmount_calculation_floatingRateCalculation_floorRateSchedule_initialValue" dataType="decimal" >
              <value>
                <xsl:value-of select="data[@name='STREAM_FLOORRATE']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="capFloorStream_calculationPeriodAmount_calculation_floatingRateCalculation_capRateSchedule_initialValue" dataType="decimal" >
              <value>
                <xsl:value-of select="data[@name='STREAM_CAPRATE']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="premium1_payer" dataType="string">
              <value>
                <xsl:value-of select="data[@name='PREMIUM_PAYER']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="premium1_paymentDate_unadjustedDate" dataType="date">
              <value>
                <xsl:value-of select="data[@name='PREMIUM_DATE']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="premium1_paymentDate_dateAdjustments_bDC" dataType="string">
              <value>
                <xsl:value-of select="data[@name='PREMIUM_BDC']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="premium1_paymentQuote_percentageRateOrpercentageRateFraction" dataType="decimal">
              <value>
                <xsl:value-of select="data[@name='PREMIUM_RATE']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="premium1_paymentAmount_amount" dataType="decimal" >
              <value>
                <xsl:value-of select="data[@name='PREMIUM_AMOUNT']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="premium1_paymentAmount_currency" dataType="string">
              <value>
                <xsl:value-of select="data[@name='PREMIUM_AMOUNT_CURRENCY']"/>
              </value>
            </customCaptureInfo>
            <customCaptureInfo clientId="premium1_settlementInformation" dataType="string">
              <value>None</value>
            </customCaptureInfo>
