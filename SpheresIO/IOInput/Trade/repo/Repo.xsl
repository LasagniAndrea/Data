		...
		<row>
			...
			<tradeImport>
				<settings>
					...
					<parameters>
						<parameter name="http://www.efs.org/otcml/tradeImport/instrumentIdentifier" datatype="string">repo</parameter>
						<parameter name="http://www.efs.org/otcml/tradeImport/templateIdentifier" datatype="string">repo</parameter>
						<!-- screen from instrument default -->
						<parameter name="http://www.efs.org/otcml/tradeImport/screen" datatype="string">Repo</parameter>
						<!--/////-->
						<parameter name="http://www.efs.org/otcml/tradeImport/displayname" datatype="string">repo Import Sample</parameter>
						<parameter name="http://www.efs.org/otcml/tradeImport/description" datatype="string">repo Import Sample</parameter>
				...
				<tradeInput>
					<customCaptureInfos>
						...
						<!-- Repo        -->
						<!-- *********** -->
						<customCaptureInfo clientId="repo_duration" dataType="string">
							<value>
								<xsl:value-of select="data[@name='repo_duration']"/>
							</value>
						</customCaptureInfo>
						<customCaptureInfo clientId="repo_effectiveMinDate" dataType="date">
							<value>
								<xsl:value-of select="data[@name='repo_effectiveMinDate']"/>
							</value>
						</customCaptureInfo>
						<customCaptureInfo clientId="repo_terminationMaxDate" dataType="date">
							<value>
								<xsl:value-of select="data[@name='repo_terminationMaxDate']"/>
							</value>
						</customCaptureInfo>
						<customCaptureInfo clientId="repo_noticePeriod_periodMultiplier" dataType="integer" regex="RegexInteger">
							<value>
								<xsl:value-of select="data[@name='repo_noticePeriod_periodMultiplier']"/>
							</value>
						</customCaptureInfo>
						<customCaptureInfo clientId="repo_noticePeriod_period" dataType="string">
							<value>
								<xsl:value-of select="data[@name='repo_noticePeriod_period']"/>
							</value>
						</customCaptureInfo>
						<customCaptureInfo clientId="repo_noticePeriod_dayType" dataType="string">
							<value>
								<xsl:value-of select="data[@name='repo_noticePeriod_dayType']"/>
							</value>
						</customCaptureInfo>
						...
						<!-- Repo_SpotLeg1 -->
						<!-- ************* -->
						<customCaptureInfo clientId="repo_spotLeg1_debtSecurityTransaction_securityAsset_securityId" dataType="string">
							<value>
						...
						<!-- orderQuantity -->
						<!-- ************* -->
						<customCaptureInfo clientId="repo_spotLeg1_debtSecurityTransaction_orderQuantity_quantityType" dataType="string">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='orderQuantity_quantityType']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="repo_spotLeg1_debtSecurityTransaction_orderQuantity_quantityAmount" dataType="decimal">
							<xsl:element name ="value">
						...
						<!-- orderPrice -->
						<!-- ********** -->
						<customCaptureInfo clientId="repo_spotLeg1_debtSecurityTransaction_orderPrice_assetMesure" dataType="string">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='orderPrice_assetMesure']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="repo_spotLeg1_debtSecurityTransaction_orderPrice_priceUnits" dataType="string">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='orderPrice_priceUnits']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="repo_spotLeg1_debtSecurityTransaction_orderPrice_price" dataType="decimal">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='orderPrice_price']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="repo_spotLeg1_debtSecurityTransaction_orderPrice_accruedInterestRate" dataType="decimal">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='orderPrice_accruedInterestRate']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="repo_spotLeg1_debtSecurityTransaction_orderPrice_accruedInterestAmount_amount" dataType="decimal">
							<xsl:element name ="value">
						...
						<!-- grossAmount -->
						<!-- *********** -->
						<customCaptureInfo clientId="repo_spotLeg1_debtSecurityTransaction_grossAmount_payer" dataType="string">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='grossAmount_payer']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="repo_spotLeg1_debtSecurityTransaction_grossAmount_paymentAmount_amount" dataType="decimal">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='grossAmount_paymentAmount_amount']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="repo_spotLeg1_debtSecurityTransaction_grossAmount_paymentAmount_currency" dataType="string">
							<xsl:element name ="value">
						...
						<!-- cashStream  -->
						<!-- *********** -->
						<customCaptureInfo clientId="repo_cashStream1_payer" dataType="string">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='repo_cashStream_payer']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="repo_cashStream1_calculationPeriodAmount_calculation_notionalSchedule_notionalStepSchedule_initialValue" dataType="decimal">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='repo_cashStream_initialValue']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="repo_cashStream1_calculationPeriodAmount_calculation_notionalSchedule_notionalStepSchedule_currency" dataType="string">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='repo_cashStream_currency']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="repo_cashStream1_calculationPeriodAmount_calculation_rate" dataType="string" regex="RegexRate">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='repo_cashStream_rate']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="repo_cashStream1_calculationPeriodDates_calculationPeriodFrequency_periodMultiplier" dataType="integer" regex="RegexInteger">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='repo_cashStream_calculationPeriodFrequency_periodMultiplier']"/>
							</xsl:element>
						</customCaptureInfo>
						<customCaptureInfo clientId="repo_cashStream1_calculationPeriodDates_calculationPeriodFrequency_period" dataType="string">
							<xsl:element name ="value">
								<xsl:value-of select="data[@name='repo_cashStream_calculationPeriodFrequency_period']"/>
							</xsl:element>
						</customCaptureInfo>
					</customCaptureInfos>
				</tradeInput>
