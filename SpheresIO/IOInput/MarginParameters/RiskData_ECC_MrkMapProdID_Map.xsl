...
<!-- 
/*============================================================================
/* Name     : RiskData_ECC_MrkMapProdID_Map.xsl
/*============================================================================
/* Summary  : Importation du Mapping des contrats sur les Combined Commodity 
/*            pour le Market Volume nécessaires au calcul du Concentraion Risk
/*            Margin de l'ECC
-->
<!-- PM 20190904 [24878] Création -->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="vXSLFileName">RiskData_ECC_MrkMapProdID_Map.xsl</xsl:variable>
  ...
  <xsl:template match="r">
    ...
    <r id="{@id}" src="{@src}" uc="true">
      ...
      <tbl n="IMECCCONRCTR_H" a="IU">
        <c n="DTBUSINESS" dk="true" t="dt" v="{$vBusinessDate}"/>
        <c n="CONTRACTSYMBOL" dk="true" v="{./d[@n='ProdId']/@v}"/>
        <c n="COMBCOMSTRESS" dku="true" v="{./d[@n='CombComStress']/@v}"/>
        <!-- InfoTable_IU -->
