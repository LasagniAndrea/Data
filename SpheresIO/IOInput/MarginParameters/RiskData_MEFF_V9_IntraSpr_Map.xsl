...
<!--
/*==============================================================
/* Name     : RiskData_MEFF_V9_IntraSpr_Map.xsl
/*==============================================================
/* Summary  : Import MEFF V9 Intra-commodity spreads
/*==============================================================
/* Version  : 3.3
/* Date     : 20130411
/* Author   : PM
/* Comment  : Mapping de l'importation des paramètres de spreads
/*            intra-commodity utilisés par le calcul de déposit
/*            MEFFCOM2.
/*==============================================================
/* Revision : 
/* Date     : 
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="vXSLFileName">RiskData_MEFF_V9_IntraSpr_Map.xsl</xsl:variable>
  ...
  <xsl:template match="r">
    ...
    <r uc="true">
      <tbl n="IMMEFFINTRASPR_H" a="IU">
        ...
        <c n="FACTOR" dku="true" t="dc">
          <xsl:call-template name="AttribValueOrNull">
            <xsl:with-param name="pValue" select="./d[@n='Factor']/@v"/>
          </xsl:call-template>
        </c>
        <c n="MINIMUMVALUE" dku="true" t="dc" v="{./d[@n='MinValue']/@v}"/>
        <c n="SPREAD" dku="true" t="dc">
          <xsl:call-template name="AttribValueOrNull">
            <xsl:with-param name="pValue" select="./d[@n='Spread']/@v"/>
          </xsl:call-template>
        </c>
        <c n="DAYCALC" dku="true" v="{./d[@n='DayCalc']/@v}"/>
        <!-- InfoTable_IU -->
