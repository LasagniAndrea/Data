...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"  version="1.0">
  ...
  <!--
	==============================================================
	Summary : FxOptionLeg ISDA Business
	==============================================================
	File    : FxOptionLeg_ISDA_Business.xslt
	Date    : 20.05.2009
  ...
  <!-- Parties variables -->
  <xsl:variable name="partyID_1" select="//dataDocument/trade/fxSimpleOption/buyerPartyReference/@href"/>
  <xsl:variable name="partyID_2" select="//dataDocument/trade/fxSimpleOption/sellerPartyReference/@href"/>
  <!-- variable in false -->
