...
================================================================================================================
 ...
 Version 1.0.0.0 (Spheres 2.6.4.x)
 Date: 01/08/2012
 Author: MF
 Description: Detailed financial report, in other words a financial report including amount details for any derivative contract  

 Version 1.0.1.0 (Spheres 2.6.7.x)
 Date: 19/09/2012
 Author: FI
 Description: 
 - Alignment of titles (optionPremium, variationMargin, cashSettlement, FeesVAT)
 - No Contervalue in detail

Version 1.0.2.0 (Spheres 3.4.4916)
 Date: 17/06/2013
 Author: RD
 Description: Gérer la nouvelle formule (A1 + A2) - (B1 + B2), ticket [18320]
================================================================================================================
  -->
  ...
  <xsl:variable name="gGroupDisplaySettings">
    <group sort="1" name="CBStream" isDataGroup="{true()}" padding-top="{$gGroupPaddingTop}" withNewPage="{true()}" table-omit-header-at-break="true">
      <!--Titles-->
      ...
      <column number="04" name="TS-Designation4" width="8mm" >
        <header colspan="-1"/>
        <data display-align="center" />
      </column>
      <column number="05" name="TS-Designation5" width="31mm" >
        <header colspan="-1"/>
        <data display-align="center" />
      </column>
      ...
      <column number="09" name="TS-Desc" width="25mm" font-size="6pt">
        <header ressource=" " colspan="2" border-right-style="none"/>
        <data font-style="italic" display-align="center"/>
      </column>
      <column number="10" name="TS-ExCurrency" width="8mm">
        <header colspan="-1"/>
        <data text-align="right" display-align="center" border-right-style="none"/>
      </column>
      <column number="11" name="TS-ExAmount" width="26mm">
      ...
      <column number="12" name="TS-ExCrDr" width="3.5mm" font-size="{$gDetTrdDetFontSize}">
        <header colspan="-1"/>
        <data border-left-style="none" display-align="center"/>
      </column>
      ...
      <!-- 20120827 MF Ticket 18065 Item 7 START -->
      ...
      <condition name="show" condition="marginRequirement"/>
      <!-- 20120827 MF Ticket 18065 Item 7 END -->

      <!--rows-->
      <row sort="1" name="cashDayBefore" font-size="8pt" font-weight="bold">
        <column name="TS-Designation1">
          <data colspan="5" value="%%RES:CSHBAL-cashDayBefore%%" />
        </column>
      ...
      <row sort="2" name="cashMouvements" font-size="8pt" >
        <column name="TS-Designation1">
          <data colspan="5" value="%%RES:CSHBAL-cashMouvements%%"/>
        </column>
        <column name="TS-Currency"/>
        <column name="TS-Amount">
      ...
      <row sort="3" name="optionPremium-detail" font-size="8pt" >
        <!--<column name="TS-Designation1">
          <data rowspan="%%DATA:rowspan%%" hide="%%DATA:hideEmptyCell%%"/>
        </column>-->
        <column name="TS-Designation1">
          <data rowspan="%%DATA:rowspanAmount%%" value="%%RES:CSHBAL-optionPremium%%" hide="%%DATA:hideAmountName%%" colspan="2"/>
        </column>
        <column name="TS-Designation3">
          <data rowspan="%%DATA:rowspanMarketCss%%" value="%%DATA:nameMarket%%" hide="%%DATA:hideMarketName%%" font-size="7pt"/>
        </column>
        <column name="TS-Designation4">
          <data colspan="2" value="%%DATA:nameDc%%" font-size="7pt"/>
        </column>
        <column name="TS-Currency"/>
        <column name="TS-Amount">
          <data value="%%DATA:amount%%" font-size="7pt"/>
        </column>
        <column name="TS-CrDr">
          <data value="%%DATA:crDr%%"/>
        </column>
        ...
        <column name="TS-ExCurrency"/>
        <column name="TS-ExAmount">
          <!--<data value="%%DATA:exAmount%%" font-size="7pt"/>-->
        </column>
        <column name="TS-ExCrDr"/>
      </row>
      <row sort="4" name="optionPremium" font-size="8pt" >
        <!--<column name="TS-Designation1">
          <data rowspan="%%DATA:rowspan%%" hide="%%DATA:hideEmptyCell%%"/>
        </column>-->
        <column name="TS-Designation1">
          <data value="%%RES:CSHBAL-optionPremium%%" hide="%%DATA:hideAmountName%%" colspan="2"/>
        </column>
        <column name="TS-Designation3">
          <data colspan="3" value="%%RES:CSHBAL-Total%%" font-weight="bold" condition="%%DATA:showTotal%%"/>
        </column>
        <column name="TS-Currency"/>
        <column name="TS-Amount">
          <data value="%%DATA:amount%%" font-weight="bold"/>
      ...
      <row sort="5" name="variationMargin-detail" font-size="8pt" >
        <column name="TS-Designation1">
      ...
      <row sort="6" name="variationMargin" font-size="8pt" >
        <column name="TS-Designation1">
      ...
      <row sort="7" name="cashSettlement-detail" font-size="8pt" >
        <column name="TS-Designation1">
      ...
      <row sort="8" name="cashSettlement" font-size="8pt" >
        <column name="TS-Designation1">
      ...
      <row sort="9" name="feesVAT-detail" font-size="8pt" >
        <column name="TS-Designation1">
      ...
      <row sort="10" name="feesVAT" font-size="8pt" >
        <column name="TS-Designation1">
          <data value="%%RES:CSHBAL-feesVAT%%" hide="%%DATA:hideAmountName%%" colspan="2"/>
        </column>
        <column name="TS-Designation3">
          <data colspan="3" value="%%RES:CSHBAL-Total%%" font-weight="bold" condition="%%DATA:showTotal%%"/>
        </column>
      ...
      <row sort="11" name="returnCallDeposit" font-size="8pt" >
        <column name="TS-Designation1">
          <data colspan="5" value="%%RES:CSHBAL-returnCallDeposit%%"/>
        </column>
        <column name="TS-Currency"/>
        <column name="TS-Amount">
          <data value="%%DATA:amount%%" font-weight="bold"/>
      ...
      <row sort="12" name="todayCashBalance" font-size="8pt" font-weight="bold" background-color="{$gDetTrdTotalBackgroundColor}">
        <column name="TS-Designation1">
          <data colspan="5"
      ...
      <row sort="13" name="%%EMPTY%%" height="2mm" condition="IsFeesDetailsExist"/>
      <row sort="14" name="%%FREE%%" condition="IsFeesDetailsExist"
           font-size="7pt" font-weight="bold"
           background-color="{$gDetTrdHdrCellBackgroundColor}">
        <column number="01" name="%%EMPTY%%"/>
        <column name="TS-Designation2">
          <data colspan="4" value="%%RES:CSHBAL-feesConstituents%%"/>
        </column>
        <column number="03" name="%%EMPTY%%">
          <data colspan="7" border-left-style="solid"/>
        </column>
      </row>
      <row sort="15" name="feeGrossAmount" dataLink="%%DATA:keyForSum%%" font-size="7pt">
        <column name="%%EMPTY%%"/>
        <column name="TS-Designation2">
        ...
        <row sort="16" name="feeGrossAmount-detail" dataLink="%%DATA:keyForSum%%" font-size="7pt">
          <column name="%%EMPTY%%">
            <data border-right-style="solid"/>
          </column>
          <column name="TS-Designation3">
            <data rowspan="%%DATA:rowspanAmount%%" value="%%RES:CSHBAL-feeGrossAmount%%" hide="%%DATA:hideAmountName%%" text-align="right" border-left-style="none"/>
          </column>
          <column name="TS-Designation4">
            <data rowspan="%%DATA:rowspanMarketCss%%" value="%%DATA:nameMarket%%" hide="%%DATA:hideMarketName%%"/>
          </column>
          <column name="TS-Designation5">
            <data value="%%DATA:nameDc%%"/>
          </column>
          <column name="TS-Currency"/>
          <column name="TS-Amount">
            <data value="%%DATA:amount%%"/>
        ...
        <row sort="16" name="feeGrossAmount" dataLink="%%DATA:keyForSum%%" font-size="7pt">
          <column name="%%EMPTY%%">
            <data border-right-style="solid"/>
          </column>
          <column name="TS-Designation3">
            <data rowspan="%%DATA:rowspanAmount%%" value="%%RES:CSHBAL-feeGrossAmount%%" hide="%%DATA:hideAmountName%%" />
          </column>
          <column name="TS-Designation3">
            <data font-weight="bold" colspan="2" value="%%RES:CSHBAL-Total%%" />
          </column>
          <column name="TS-Currency"/>
          <column name="TS-Amount">
            <data font-weight="bold" value="%%DATA:amount%%"/>
          </column>
          <column name="TS-CrDr">
            <data font-weight="bold" value="%%DATA:crDr%%"/>
          </column>
          <column name="TS-Desc"/>
          <column name="TS-ExCurrency"/>
          <column name="TS-ExAmount">
            <data font-weight="bold" value="%%DATA:exAmount%%"/>
          </column>
          <column name="TS-ExCrDr">
            <data font-weight="bold" value="%%DATA:crDr%%"/>
          </column>
        </row>
        <row sort="17" name="feeTax" dataLink="%%DATA:keyForSum%%" font-size="7pt">
          <column name="%%EMPTY%%">
            <data border-right-style="solid"/>
          </column>
          <column name="TS-Designation3">
            <data colspan="3" value="%%DATA:taxDetailName.RES%% (">
      ...
      <row sort="18" name="totalFeesVAT" font-size="7pt" font-weight="bold" background-color="{$gDetTrdHdrCellBackgroundColor}">
      ...
      <row sort="19" name="%%EMPTY%%" height="2mm" />
      <row sort="20" name="%%FREE%%"
      ...
      <row sort="21" name="previousMarginRequirement" font-size="7pt" >
        <column name="%%EMPTY%%"/>
        <column name="TS-Designation2">
          <data rowspan="%%DATA:rowspan%%" value="%%RES:CSHBAL-previousOrders%%"/>
        </column>
        <column name="TS-Designation3">
          <data colspan="3" value="%%RES:CSHBAL-previousMarginRequirement%%"/>
        </column>
        <column name="TS-Currency"/>
        <column name="TS-Amount">
          <data value="%%DATA:amount%%"/>
      ...
      <row sort="22" name="previousCollateralAvailable" font-size="7pt">
        <column name="%%EMPTY%%">
          <data border-right-style="solid"/>
        </column>
        <column name="TS-Designation3">
        ...
        <column name="TS-Designation4">
          <data colspan="2" value="%%RES:CSHBAL-Available%%" font-style="italic">
      ...
      <row sort="23" name="previousCollateralUsed" font-size="7pt">
        <column name="%%EMPTY%%">
          <data border-right-style="solid"/>
        </column>
        <column name="TS-Designation4">
          <data colspan="2" value="%%RES:CSHBAL-Used%%"/>
        </column>
        <column name="TS-Currency"/>
        <column name="TS-Amount">
          <data value="%%DATA:amount%%"/>
      ...
      <row sort="24" name="previousCashAvailable" font-size="7pt">
        <column name="%%EMPTY%%">
          <data border-right-style="solid"/>
        </column>
        <column name="TS-Designation3">
        ...
        <column name="TS-Designation4">
          <data colspan="2" value="%%RES:CSHBAL-Available%%" font-style="italic" text-align="left"/>
        </column>
        <column name="TS-Currency"/>
        <column name="TS-Amount">
          <data value="%%DATA:amount%%" font-style="italic" text-align="left"/>
      ...
      <row sort="25" name="previousCashUsed" font-size="7pt">
        <column name="%%EMPTY%%">
          <data border-right-style="solid"/>
        </column>
        <column name="TS-Designation4">
      ...
      <row sort="26" name="previousUncoveredMarginRequirement" font-size="7pt" font-weight="bold" >
        <column name="%%EMPTY%%">
          <data border-right-style="solid"/>
        </column>
        <column name="TS-Designation3">
          <data colspan="3" value="%%RES:CSHBAL-previousUncoveredMarginRequirement%%">
            <inline font-size="60%" baseline-shift="super">
              <xsl:choose>
      ...
      <row sort="27" name="marginRequirement-detail" font-size="7pt" >
        <column name="%%EMPTY%%">
          <data border-right-style="solid"/>
        </column>
        <column name="TS-Designation2">
          <data rowspan="%%DATA:rowspan%%" value="%%RES:CSHBAL-todayOrders%%" hide="%%DATA:hideEmptyCell%%"/>
        </column>
        <column name="TS-Designation3">
          <data rowspan="%%DATA:rowspanAmount%%" value="%%RES:CSHBAL-marginRequirement%%" hide="%%DATA:hideAmountName%%"/>
        </column>
        <column name="TS-Designation4">
          <data colspan="2" value="%%DATA:nameCss%%" font-style="italic"/>
        </column>
        <column name="TS-Currency"/>
        <column name="TS-Amount">
          <data value="%%DATA:amount%%" font-style="italic" text-align="left"/>
      ...
      <row sort="28" name="marginRequirement" font-size="7pt">
        <column name="%%EMPTY%%">
          <data border-right-style="solid"/>
        </column>
        <column name="TS-Designation2">
        ...
        <column name="TS-Designation3">
          <data value="%%RES:CSHBAL-marginRequirement%%" hide="%%DATA:hideAmountName%%"/>
        </column>
        <column name="TS-Designation4">
          <data colspan="2" value="%%RES:CSHBAL-Total%%" condition="%%DATA:showTotal%%"/>
        </column>
        <column name="TS-Currency"/>
        <column name="TS-Amount">
          <data value="%%DATA:amount%%"/>
      ...
      <row sort="29" name="collateralAvailable" font-size="7pt">
        <column name="%%EMPTY%%">
          <data border-right-style="solid"/>
        </column>
        <column name="TS-Designation3">
      ...
      <row sort="30" name="collateralUsed" font-size="7pt">
        <column name="%%EMPTY%%">
          <data border-right-style="solid"/>
        </column>
        <column name="TS-Designation4">
      ...
      <row sort="31" name="cashAvailable" font-size="7pt">
        <column name="%%EMPTY%%">
          <data border-right-style="solid"/>
        </column>
        <column name="TS-Designation3">
      ...
      <row sort="32" name="cashUsed" font-size="7pt">
        <column name="%%EMPTY%%">
          <data border-right-style="solid"/>
        </column>
        <column name="TS-Designation4">
      ...
      <row sort="33" name="uncoveredMarginRequirement" font-size="7pt" font-weight="bold" >
        <column name="%%EMPTY%%">
          <data border-right-style="solid"/>
        </column>
        <column name="TS-Designation3">
          <data colspan="3" value="%%RES:CSHBAL-uncoveredMarginRequirement%%">
            <inline font-size="60%" baseline-shift="super">
              <xsl:choose>
                <xsl:when test="$gUseAvailableCash = 'true'">
      ...
      <row sort="34" name="returnCallDepositAB" font-size="7pt" font-weight="bold" background-color="{$gDetTrdHdrCellBackgroundColor}">
        <column name="%%EMPTY%%" background-color="white"/>
        <column name="TS-Designation2">
          <data colspan="4"
    ...
    <group sort="2" name="CBStreamEx" isDataGroup="{true()}" padding-top="{$gGroupPaddingTop}" table-omit-header-at-break="true">
      ...
      <column number="07" name="TS-ExAmount" width="26mm">
        <header text-align="right" ressource="%%RES:CSHBAL-CounterValueTitle%% {$gReportingCurrency}"
                colspan="2" font-size="8pt" font-weight="bold" border-left-style="none"/>
        <data text-align="right" display-align="center" border-left-style="none" border-right-style="none" decPattern="%%PAT:RepCurrency%%"/>
      </column>
