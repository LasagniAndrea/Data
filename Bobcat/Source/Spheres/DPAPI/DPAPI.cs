...
namespace EFS.DPAPI
{
    ...
    internal static class NativeMethods
    {
        ...
        internal static extern bool CryptProtectData(ref DATA_BLOB pDataIn, [MarshalAs(UnmanagedType.LPWStr)] String szDataDescr,
            ref DATA_BLOB pOptionalEntropy, IntPtr pvReserved, ref CRYPTPROTECT_PROMPTSTRUCT pPromptStruct, 
            int dwFlags, ref DATA_BLOB pDataOut);

        // EG 20180423 Analyse du code Correction [CA2101]
        [DllImport("Crypt32.dll", SetLastError = true, CharSet = CharSet.Auto)]
        internal static extern bool CryptUnprotectData(ref DATA_BLOB pDataIn, [MarshalAs(UnmanagedType.LPWStr)] String szDataDescr,
            ref DATA_BLOB pOptionalEntropy, IntPtr pvReserved, ref CRYPTPROTECT_PROMPTSTRUCT pPromptStruct, 
            int dwFlags, ref DATA_BLOB pDataOut);

        [DllImport("kernel32.dll", CharSet = CharSet.Auto)]
        unsafe internal static extern int FormatMessage(int dwFlags, ref IntPtr lpSource,
    ...
    public class DataProtector 
	{
        ...
        public byte[] Encrypt(byte[] plainText, byte[] optionalEntropy)
		{
			...
			try
			{
                ...
                retVal = NativeMethods.CryptProtectData(ref plainTextBlob, "", ref entropyBlob, IntPtr.Zero, ref prompt, dwFlags, ref cipherTextBlob);
				if(false == retVal)
				{
        ...
        public byte[] Decrypt(byte[] cipherText, byte[] optionalEntropy)
		{
			...
			try
			{
                ...
                retVal = NativeMethods.CryptUnprotectData(ref cipherBlob, null, ref entropyBlob, 
        ...
        private unsafe static String GetErrorMessage(int errorCode)
		{
            ...
            int retVal = NativeMethods.FormatMessage(dwFlags, ref ptrlpSource, errorCode, 0, 
