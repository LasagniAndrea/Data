...
namespace EFS.DALOracleManaged
{
    ...
    public sealed class DataAccess : DataAccessBase, ICultureParameter
    {
        ...
        public override string GetServerVersion(string pCS)
        {
            ...
            using (OracleConnection testConn = new OracleConnection(pCS))
            {
                testConn.Open();
                ret = "Oracle " + testConn.ServerVersion;
                testConn.Close();
            }
            return ret;
        }
        ...
        private OracleConnection OpenOracleConnection(string pConnectionString)
        {
            OracleConnection cn = new OracleConnection(pConnectionString);
            cn.Open();
            //
            return cn;
        }
        ...
        public override int ExecuteNonQueryXmlForOracle(string connectionString, string commandText,
            XmlDocument pXml, string pXmlParameterName, params IDbDataParameter[] commandParameters)
        {
