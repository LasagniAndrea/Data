	...
	public class Vision
	{
        ...
        public Cst.ErrLevel PrintPDF(PageBase pPage, string pTableName, int pIdA, string pIdLstTemplate, string pIdLstConsult) 
		{
            ...
            try
			{
				...
				bool isPwdCrypted = ( SystemSettings.GetAppSettings( Software.Name + "_" + "IsPwdCrypted" ) == "1" ? true : false );
				if ( isPwdCrypted ) 
				...
				sWorkingDirectory = SystemSettings.GetAppSettings_Software("_PDFGenerator");
