...
function Init() {
    ...
    $("#DDLGPRODUCT,#DDLTYPEINSTR").change(function () {
        ...
        if (typeInstr.length > 0) {
            switch (typeInstr) {
                case 'GrpInstr':
                    LoadDataTable(['ID_', 'DISPLAYNAME'], 'VW_FUNDINGSCHEDINSTR', [{ col: 'TYPEINSTR', value: typeInstr }], function (vw) {
                ...
                default:
                    ...
                    LoadDataTable(['ID_', 'DISPLAYNAME'], 'VW_FUNDINGSCHEDINSTR', restrict, function (vw) {
                        LoadDDL("DDLIDINSTR", vw);
                    });
                    break;
            }
    ...
    $("#DDLTYPEINSTR_UNL").change(function () {
        ...
        if (typeInstr.length > 0) {
            LoadDataTable(['ID_', 'DISPLAYNAME'], 'VW_FUNDINGSCHEDINSTR', [{ col: 'TYPEINSTR_UNL', value: typeInstr }], function (vw) {
