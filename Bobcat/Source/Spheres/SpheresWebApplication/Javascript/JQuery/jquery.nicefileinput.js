...
(function($) {
	$.fn.nicefileinput = function(options) {
		var settings = { 
			label : 'Find...', // Default button text
            fullPath: false
		};
		...
		return this.each(function() {
			...
			if ($(self).attr('data-styled') === undefined) {
                ...
                $('input[id$=Upload_C]').each(function (index){$(this).hide();});
                $('input[id$=Upload_E]').each(function (index){$(this).hide();});
                $('input[id$=Upload_P]').each(function (index){$(this).hide();});
                $('input[id$=Upload_F]').each(function (index){$(this).hide();});
				...
				var wrapper = $("<div>")
					...
					.addClass('fa-icon fas fa-upload green NFI-button NFI' + guid)
					.html(settings.label);
				...
				$(self).on("change", function() {
                                	...
                                	$('input[id$=Upload_C]').each(function (index){$(this).show();});
                                    $('input[id$=Upload_E]').each(function (index){$(this).show();});
                                    $('input[id$=Upload_P]').each(function (index){$(this).show();});
                                    $('input[id$=Upload_F]').each(function (index){$(this).show();});
                                });
