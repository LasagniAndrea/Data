    ...
    internal class ExternalGraphic : FObj
    {
        ...
        public override Status Layout(Area area)
        {
            ...
            try
            {
                ...
                this.imageArea = new ImageArea(propMgr.GetFontState(area.GetFontInfo()), img, width, height, align);
            ...
            {
                // FI 20160718 Appel à FireFonetWarning de manière à ne pas générer une erreur avec l'outil BuildPdf
                //FonetDriver.ActiveDriver.FireFonetError("Error while creating area : " + imgex.Message);
                FonetDriver.ActiveDriver.FireFonetWarning("Error while creating area : " + imgex.Message);
            }
