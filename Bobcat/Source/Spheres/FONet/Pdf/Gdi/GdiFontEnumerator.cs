    ...
    public class GdiFontEnumerator {
        ...
        public string[] FamilyNames
        {
            get {
                ...
                NativeMethods.EnumFontFamiliesEx(dc.Handle, lf, font, new IntPtr(ExtractFamilies), 0);
        ...
        public FontStyles GetStyles(string familyName)
        {
            styles.Clear();
            FontEnumDelegate font = new FontEnumDelegate(EnumFontMethod);
            NativeMethods.EnumFontFamilies(dc.Handle, familyName, font, new IntPtr(ExtractStyles));
