...
namespace Fonet.Pdf.Gdi {
    ...
    public class GdiFontMetrics {
        ...
        private readonly GdiFont currentFont;
        ...
        internal GdiFontMetrics(GdiDeviceContent dc, GdiFont currentFont)
        {
            ...
            NativeMethods.GetTextFace(dc.Handle, builder.Capacity, builder);
        ...
        public byte[] GetFontData()
        {
            if (data == null) {
                try {
                    ...
                    uint ttcfSize = NativeMethods.GetFontData(dc.Handle, ttcfTag, 0, null, 0);
        ...
        {
            uint bufferSize = NativeMethods.GetFontData(dc.Handle, 0, 0, null, 0);
            ...
            uint rv = NativeMethods.GetFontData(dc.Handle, 0, 0, buffer, bufferSize);
            if (rv == GDI_ERROR) {
