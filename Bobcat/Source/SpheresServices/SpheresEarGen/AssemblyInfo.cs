...
//
[assembly: AssemblyTitle("SpheresEarGen")]
[assembly: AssemblyDescription("Spheres Events administration report generation : tries to generate the EARs corresponding to valorised events that have reached maturity. EARs contain data necessary to the recognition of all events of the trade. Their convertion into accounting entries can be done within Spheres® (integrated EARs interpreter), or externally (external accounting interpreter)")]
