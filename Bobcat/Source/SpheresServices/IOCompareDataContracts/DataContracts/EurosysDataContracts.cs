...
namespace IOCompareCommon.DataContracts
{
    ...
    public sealed class CashFlowsCompareDataEurosys : ISpheresComparer, IIoTrackElements
    {
        ...
        public void Initialise()
        {
            ...
            m_QuantityByKeyName.Add("TAXCOMAMT", new ValueErrorStatus(TaxComAmt, MatchStatus.UNMATCH_TAXCOMAMT));
            m_QuantityByKeyName.Add("COLLAMT", new ValueErrorStatus(CollAmt, MatchStatus.UNMATCH_COLLAMT));
            m_QuantityByKeyName.Add("PMTAMT", new ValueErrorStatus(PmtAmt, MatchStatus.UNMATCH_PMTAMT));

            m_QuantityByKeyName.Add("PRMAMT",
               new ValueErrorStatus(0, MatchStatus.UNMATCH_PRMAMT, false));
            m_QuantityByKeyName.Add("VRMRGNAMT",
                new ValueErrorStatus(0, MatchStatus.UNMATCH_VRMRGNAMT, false));
            m_QuantityByKeyName.Add("TAXCOMBRKAMT",
                new ValueErrorStatus(0, MatchStatus.UNMATCH_TAXCOMBRKAMT, false));
            m_QuantityByKeyName.Add("CALLAMT",
                new ValueErrorStatus(0, MatchStatus.UNMATCH_CALLAMT, false));
            m_QuantityByKeyName.Add("RPTAMT",
                new ValueErrorStatus(0, MatchStatus.UNMATCH_RPTAMT, false));
        }
    ...
    public sealed class CashFlowsInstrCompareDataEurosys : ISpheresComparer, IIoTrackElements
    {
        ...
        public void Initialise()
        {
            ...
            m_QuantityByKeyName.Add("UMGAMT", new ValueErrorStatus(UMgAmt, MatchStatus.UNMATCH_UMGAMT, true));
            m_QuantityByKeyName.Add("PRMAMT", new ValueErrorStatus(0, MatchStatus.UNMATCH_PRMAMT, false));
            m_QuantityByKeyName.Add("VRMRGNAMT", new ValueErrorStatus(0, MatchStatus.UNMATCH_VRMRGNAMT, false));
            m_QuantityByKeyName.Add("LOVAMT", new ValueErrorStatus(0, MatchStatus.UNMATCH_LOVAMT, false));
            m_QuantityByKeyName.Add("RMGAMT", new ValueErrorStatus(0, MatchStatus.UNMATCH_RMGAMT, false));
            m_QuantityByKeyName.Add("TAXCOMBRKAMT", new ValueErrorStatus(0, MatchStatus.UNMATCH_TAXCOMBRKAMT, false));
        }
