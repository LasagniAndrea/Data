...
Date    : 20110829
Author  : GP
Variable name="vEnrichedSym": parameter PUTCALL ajouté dans l'appel 
au template SelectEnrichedSym
============================================================== 
Version : v1.0.0.0
Date    : 20100220
Author  : MF
...
<xsl:include href="..\Common\CommonInput.xslt"/>
  ...
  <xsl:template match="row">
    ...
    <row>
      ...
      <!-- GP20110829: parameter PUTCALL ajouté -->
      ...
      <!-- Transcode the PutCall external code : P or 0 -> 0 ; C or 1 -> 1 ; Other -> null -->
