    ...
    <row>
      ...
      <tradeImport xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
        <settings>
          ...
          <user>SYSADM</user>
          <parameters>
            <parameter name="http://www.efs.org/otcml/tradeImport/instrumentIdentifier" datatype="string">FxSpot</parameter>
            <parameter name="http://www.efs.org/otcml/tradeImport/templateIdentifier" datatype="string">Fx Spot</parameter>
            <parameter name="http://www.efs.org/otcml/tradeImport/screen" datatype="string">FxSpot-Broker</parameter>
            <!--/////-->
