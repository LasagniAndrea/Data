...
File    : ErxFixMLTradeSpheresImp-par-C7Releasev8.0.xsl
C7Release8.0 : This transformation doest not take in account erx:Instrmt/@ContractDate.
               => could be used until 6 February 2023.
               => could be used to use YYYYMM format only. Caution! => Sub-Monthly contracts (like ODX1) mandatorily require YYYYMMDD from February 2023. 
=============================================================================================
REVISIONS
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:erx="www.eurexchange.com/technology" version="1.0">
  ...
  <xsl:template match="erx:TrdCaptRpt">
    ...
    <row>
      ...
      <xsl:variable name ="executingFirm" select ="erx:Pty[@R='1']/@ID"/>
