...
//            return IOTools.GetJoinSQLQuery(IOParsingTableName, joinQuery);
...
//        protected void GetParsingDetData(int pDataNumber)
//        {
...
//                    {
//                        m_DataValue = m_DataValue.TrimStart(delimiter.ToCharArray());
//                        m_DataValue = m_DataValue.TrimEnd(delimiter.ToCharArray());
//                    }
//                }
//                else
//                {
...
//                                            dataLength = m_DataLength - Math.DivRem(m_DataLength - dataLength, 2, out resultRem);
...
//                    }
//                    //
//                    #region Appliquer le delimiteur
//                    if (StrFunc.IsFilled(delimiter))
//                        m_DataValue = delimiter + m_DataValue + delimiter;
//                    #endregion
//                }
//            }
//            catch (Exception ex)
