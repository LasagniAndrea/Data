...
namespace EFS.ServiceInstall
{
    ...
    [RunInstaller(true)]
    [ComVisible(false)]
    public class IOInstaller : SpheresServiceInstaller
    {
        public IOInstaller() : base(Cst.ServiceEnum.SpheresIO, typeof(IOInstaller)) { }
        ...
        public override void Install(System.Collections.IDictionary stateServer)
        {
            ...
            this.Context.Parameters.Add(ServiceKeyEnum.ClassType.ToString(), typeof(EFS.SpheresService.SpheresIOService).FullName);
