...
namespace EFS.TradeInformation
{
    ...
    /// </summary>
    public class CCiPrevailingTime : IContainerCci, IContainerCciFactory
    {
        #region Membres
        private readonly string _prefix = string.Empty;
        private readonly CciTrade _cciTrade;
        private IPrevailingTime _prevailingTime;
        #endregion
        ...
        public enum CciEnum
        {
            [System.Xml.Serialization.XmlEnumAttribute("hourMinuteTime")]
            hourMinuteTime,
        ...
        /// 
        /// </summary>
        public IPrevailingTime PrevailingTime
        {
            get
            {
                return _prevailingTime;
            }
            set
            {
                _prevailingTime = value;
            }
        }
        ...
        public CCiPrevailingTime(CciTrade pCCiTrade, string pPrefix, IPrevailingTime pPrevailingTime)
        {
            _cciTrade = pCCiTrade;
            _prefix = pPrefix + CustomObject.KEY_SEPARATOR; 
            _prevailingTime = pPrevailingTime;
        }
        #endregion
        ...
        {
            CciTools.CreateInstance(this, _prevailingTime);
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            CciTools.AddCciSystem(Ccis, Cst.TXT + CciClientId(CciEnum.location), false, TypeData.TypeDataEnum.@string);
        }
        /// <summary>
        ...
        public void Initialize_FromDocument()
        {
            foreach (CciEnum cciEnum in Enum.GetValues(typeof(CciEnum)))
            {
                ...
                if (cci != null)
                {
                    ...
                    switch (cciEnum)
                    {
                        case CciEnum.hourMinuteTime:
                            data = _prevailingTime.HourMinuteTime.Value; 
                            break;
                        case CciEnum.location:
                             data = _prevailingTime.Location.Value;
                            break;
                        default:
                            isSetting = false;
                            break;
            ...
            foreach (string enumName in Enum.GetNames(tCciEnum))
            {
                ...
                if ((cci != null) && (cci.HasChanged))
                {
                    ...
                    switch (keyEnum)
                    {
                        ...
                        case CciEnum.hourMinuteTime:
                            _prevailingTime.HourMinuteTime.Value = data;
                            processQueue = CustomCaptureInfosBase.ProcessQueueEnum.High;
                            break;
                        case CciEnum.location:
                            _prevailingTime.Location.Value = data;
                            processQueue = CustomCaptureInfosBase.ProcessQueueEnum.High;
                            break;
                        default:
                            isSetting = false;
