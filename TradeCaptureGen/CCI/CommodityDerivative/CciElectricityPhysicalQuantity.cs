...
{
    /// <summary>
    /// CCI The different options for specifying the quantity.
    /// </summary>
    public class CciElectricityPhysicalQuantity : IContainerCci, IContainerCciFactory
    {
        ...
        /// 
        /// </summary>
        private readonly IElectricityPhysicalQuantity _electricityPhysicalQuantity;
        ...
        public IElectricityPhysicalQuantity ElectricityPhysicalQuantity
        {
            get
            {
                return _electricityPhysicalQuantity;
            }
        ...
        #region constructor
        public CciElectricityPhysicalQuantity(CciTrade pCCiTrade, string pPrefix, IElectricityPhysicalQuantity pElectricityPhysicalQuantity)
        {
            _cciTrade = pCCiTrade;
            _prefix = pPrefix + CustomObject.KEY_SEPARATOR;
            _electricityPhysicalQuantity = pElectricityPhysicalQuantity;
        }
        #endregion
        ...
        {
            CciTools.CreateInstance(this, _electricityPhysicalQuantity);
                ...
                if (cci != null)
                {
                    ...
                    switch (cciEnum)
                    {
                        case CciEnum.totalPhysicalQuantity_quantity:
                            if (_electricityPhysicalQuantity.TotalPhysicalQuantitySpecified)
                                data = _electricityPhysicalQuantity.TotalPhysicalQuantity.Quantity.Value;
                            break;
                        case CciEnum.totalPhysicalQuantity_quantityUnit:
                            if (_electricityPhysicalQuantity.TotalPhysicalQuantitySpecified)
                                data = _electricityPhysicalQuantity.TotalPhysicalQuantity.QuantityUnit.Value;
                            break;
                        default:
                            isSetting = false;
                            break;
        ...
        public void Dump_ToDocument()
        {
            ...
            foreach (string enumName in Enum.GetNames(tCciEnum))
            {
                ...
                if ((cci != null) && (cci.HasChanged))
                {
                    ...
                    {
                        case CciEnum.totalPhysicalQuantity_quantity:
                            _electricityPhysicalQuantity.TotalPhysicalQuantitySpecified = StrFunc.IsFilled(data);
                            if (_electricityPhysicalQuantity.TotalPhysicalQuantitySpecified)
                                _electricityPhysicalQuantity.TotalPhysicalQuantity.Quantity.Value = data;
                            processQueue = CustomCaptureInfosBase.ProcessQueueEnum.High;
                            break;
                        case CciEnum.totalPhysicalQuantity_quantityUnit:
                            _electricityPhysicalQuantity.TotalPhysicalQuantity.QuantityUnit.Value = data;
                            processQueue = CustomCaptureInfosBase.ProcessQueueEnum.High;
                            break;
                        default:
                            isSetting = false;
        ...
        private void InitializePhysicalQuantity_FromCci()
        {
            ...
            Boolean saveSpecified = _electricityPhysicalQuantity.PhysicalQuantitySpecified;

            ICommodityNotionalQuantity[] quantity = _electricityPhysicalQuantity.PhysicalQuantity;
            ...
            while (isOk)
            {
                ...
                if (isOk)
                {
                    ...
                    {
                        ReflectionTools.AddItemInArray(_electricityPhysicalQuantity, "physicalQuantity", index);
                        quantity = _electricityPhysicalQuantity.PhysicalQuantity;
                    }

                    cciQuantityItem.CommodityNotionalQuantity = _electricityPhysicalQuantity.PhysicalQuantity[index];
            ...
            _electricityPhysicalQuantity.PhysicalQuantitySpecified = saveSpecified;
        }
