...
namespace EFS.TradeInformation
{
    ...
    /// </summary>
    public class CciGasDelivery : IContainerCci, IContainerCciFactory
    {
        #region Membres
        private readonly string _prefix = string.Empty;
        private readonly CciTrade _cciTrade;
        private readonly IGasDelivery _gasDelivery;
        #endregion
        ...
        #region constructor
        public CciGasDelivery(CciTrade pCCiTrade, string pPrefix, IGasDelivery pGasDelivery)
        {
            _cciTrade = pCCiTrade;
            _prefix = pPrefix + CustomObject.KEY_SEPARATOR;
            _gasDelivery = pGasDelivery;
        }
        #endregion
        ...
        {
            CciTools.CreateInstance(this, _gasDelivery);
        }
        /// <summary>
        /// 
        /// </summary>
                ...
                if (cci != null)
                {
                    ...
                    switch (cciEnum)
                    {
                        case CciEnum.deliveryPoint:
                            if (_gasDelivery.DeliveryPointSpecified)
                                data = _gasDelivery.DeliveryPoint.Value;
                            break;
                        default:
                            isSetting = false;
                            break;
        ...
        public void Dump_ToDocument()
        {
            ...
            foreach (string enumName in Enum.GetNames(tCciEnum))
            {
                ...
                if ((cci != null) && (cci.HasChanged))
                {
                    ...
                    {
                        case CciEnum.deliveryPoint:
                            _gasDelivery.DeliveryPointSpecified = StrFunc.IsFilled(data);
                            if (_gasDelivery.DeliveryPointSpecified)
                                _gasDelivery.DeliveryPoint.Value = data;
                            break;
                        default:
                            isSetting = false;
                            break;
