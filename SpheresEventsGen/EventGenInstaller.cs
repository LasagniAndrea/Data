...
namespace EFS.ServiceInstall
{
    ...
    [RunInstaller(true)]
    [ComVisible(false)]
    public class EventsGenInstaller : SpheresServiceInstaller
    {
        public EventsGenInstaller()
            : base(
            Cst.ServiceEnum.SpheresEventsGen, typeof(EventsGenInstaller)) { }
        ...
        public override void Install(System.Collections.IDictionary stateServer)
        {
            ...
            this.Context.Parameters.Add(ServiceKeyEnum.ClassType.ToString(), typeof(EFS.SpheresService.SpheresEventsGenService).FullName);
