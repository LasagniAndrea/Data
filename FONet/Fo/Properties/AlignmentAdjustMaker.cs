...
{
    internal class AlignmentAdjustMaker2 : ToBeImplementedProperty.Maker
    {
        new public static PropertyMaker Maker(string propName)
        {
            return new AlignmentAdjustMaker2(propName);
        }

        protected AlignmentAdjustMaker2(string name) : base(name) { }
    ...
    internal class AlignmentAdjustMaker : LengthProperty.Maker
    {
