/*
 * Risk_1_0_39.cs a été généré avec la commande suivante :
 * "C:\Program Files\Microsoft SDKs\Windows\v6.0A\Bin\xsd" Risk_1_0_39.xsd /classes /eld /nologo /namespace:EFS.SpheresRiskPerformance.RiskMethods.Span2RiskMargin.v1_0_39 /fields
 *
 * En ayant au préalable ajouté les 2 lignes suivantes dans le fichier XSD:
 *   <xsd:element name="riskPortfolioReq" type="cme:RiskPortfolioRequestMessage"/>
 *   <xsd:element name="marginDetailRes" type="cme:MarginDetailResponseMessage"/>
 * */
...
/// </summary>
namespace EFS.SpheresRiskPerformance.RiskMethods.Span2RiskMargin.v1_0_39
{
    /// <summary>
    /// 
    /// </summary>
    ...
    {
        #region Members
        public string greekDescription;
        public string greekName;
        public List<decimal> results;
        public string securityId;
        public List<string> underlyingPeriodCode;
        #endregion Members
        #region Accessors
        public string GreekDescription
        {
            get { return greekDescription; }
            set { greekDescription = value; }
        }
    ...
    public partial class IrsTradeLeg
    {
        ...
        {
            get { return (cleanPriceSpecified ? cleanPrice : default(decimal?)); }
            set
            {
        ...
        {
            get { return (dirtyPriceSpecified ? dirtyPrice : default(decimal?)); }
            set
            {
        ...
        {
            get { return (finalStubRtSpecified ? finalStubRt : default(decimal?)); }
            set
            {
        ...
        {
            get { return (fixedRtSpecified ? fixedRt : default(decimal?)); }
            set
            {
        ...
        {
            get { return (futureValueNotionalAmtSpecified ? futureValueNotionalAmt : default(decimal?)); }
            set
            {
        ...
        {
            get { return (initialStubRtSpecified ? initialStubRt : default(decimal?)); }
            set
            {
        ...
        {
            get { return (knownAmtSpecified ? knownAmt : default(decimal?)); }
            set
            {
        ...
        {
            get { return (netCashFlowAmtSpecified ? netCashFlowAmt : default(decimal?)); }
            set
            {
        ...
        public decimal? NotionalAmt
        {
            get { return (notionalAmtSpecified ? notionalAmt : default(decimal?)); }
            set
            {
                notionalAmtSpecified = value.HasValue;
                if (value.HasValue)
        ...
        {
            get { return (settlementRtSpecified ? settlementRt : default(decimal?)); }
            set
            {
        ...
        {
            get { return (spreadAmtSpecified ? spreadAmt : default(decimal?)); }
            set
            {
    ...
    public partial class Payment
    {
        ...
        public decimal? Amt
        {
            get { return (amtSpecified ? amt : default(decimal?)); }
            set
            {
    ...
    public partial class TradeBase : TransactionBase
    {
        ...
        {
            get { return (priceSpecified ? price : default(decimal?)); }
            set
            {
        ...
        public decimal? Qty
        {
            get { return (qtySpecified ? qty : default(decimal?)); }
            set
            {
